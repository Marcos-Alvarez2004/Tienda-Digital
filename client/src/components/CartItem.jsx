                        ...
                        isDesktop ? (
                            <>
                                {cartItems.map((product) => (
                                    <>
                                        <li key={product.id} className="flex items-center justify-between gap-x-4 h-36 bg-white border-[0.5px] border-[#ccc] my-4 lg:mb-6 lg:my-0 rounded-sm w-full py-6">
                                            <div className="flex">
                            ...
                            {cartItems.map((product) => (
                                <li key={product.id} className="flex h-36 bg-white border-[0.5px] border-[#ccc] my-4 rounded-l-sm md:w-full">
